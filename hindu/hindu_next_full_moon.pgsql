...
-------------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION calendars.hindu_next_full_moon(
...
BEGIN
	...
	-- JDE at midnight
	t_next_full_moon := calendars.midnight_offset(
		astronomia.moonphase_full_moon(
	...
	END LOOP;
    RETURN astronomia.jde_to_gregorian(t_next_full_moon)::DATE;
END;
