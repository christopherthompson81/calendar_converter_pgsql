...
------------------------------------------
--
CREATE OR REPLACE FUNCTION calendars.gregorian_to_hijri(p_date DATE)
...
DECLARE
	...
	t_index INTEGER := calendars.bisect_right(month_starts, rjd) - 1;
...
BEGIN
	-- Check date range
	IF p_date < '1924-08-01'::DATE OR p_date > '2077-11-16'::DATE THEN
